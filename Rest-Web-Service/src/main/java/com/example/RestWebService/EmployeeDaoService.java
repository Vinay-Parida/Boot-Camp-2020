...
public class EmployeeDaoService {
    ...
    static {
        employeesList.add(new Employee(1, "Vinay", 21, "Password1234"));
        employeesList.add(new Employee(2, "Ankit", 23, "Password"));
        employeesList.add(new Employee(3, "Aman", 24, "Password123"));
        employeesList.add(new Employee(4, "Aradhya", 22, "pa"));

    }

    //Part-1-Q2 Create an Employee Bean(id, name, age) and service to  perform different operations related to employee.
